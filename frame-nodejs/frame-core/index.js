...
module.exports = async function () {
	try {
		...
		global.qiniuUtil = require("./core/util/qiniuUtil");
		...
		// 短信模板
		global.SmsTemplate = require('./common/SmsTemplate');
		...
		// 全局NSQCacheKey
		global.NSQCacheKey = require('./common/NSQCacheKey');

		// 全局ChargeChannel
		global.ChargeChannel = require('./common/ChargeChannel');
